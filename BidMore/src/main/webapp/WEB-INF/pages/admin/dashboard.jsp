            ...
            <nav class="main-nav">
                <div class="logo">
                    <a href="${contextPath}/dashboard">
                        <img src="${contextPath}/resources/images/system/logo.png" alt="BidMore" 
        ...
        <div class="main-content">
            <div class="page-header">
                <div class="header-left">
                    ...
                    <p class="subtitle">Monitor your platform's key metrics and recent activity</p>
                </div>
                <div class="date-filter">
                    ...
                    <span class="refresh-btn" title="Refresh Data">
                ...
                <div class="stat-card">
                    <div class="stat-card-inner">
                        ...
                        <div class="stat-info">
                            ...
                            <div class="trend up">
                                <i class="fas fa-arrow-up">23</i> 5% this week
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="dashboard-sections">
                ...
                <div class="dashboard-section">
                    <div class="section-header">
                        ...
                        <a href="${contextPath}/admin/activities" class="view-all">View All <i class="fas fa-arrow-right"></i></a>
                    </div>
                    <div class="activity-list">
                        <div class="activity-item">
                            ...
                            <div class="activity-details">
                                <p><strong>New User Registration</strong>: John Smith joined the platform</p>
                        ...
                        <div class="activity-item">
                            ...
                            <div class="activity-details">
                                <p><strong>New Auction Created</strong>: Vintage Camera Collection</p>
                        ...
                        <div class="activity-item">
                            ...
                            <div class="activity-details">
                                <p><strong>High Bid Placed</strong>: $1,200 on Antique Watch</p>
                        ...
                        <div class="activity-item">
                            ...
                            <div class="activity-details">
                                <p><strong>Dispute Resolved</strong>: Payment issue for Art Painting</p>
