...
public class ValidationUtil {
	...
	public   boolean isAlphabetic (String value) {
		...
		//  ^ --> begins with [a-zA-Z]  && $  $ --> ends with  [a-zA-Z] && + --> one or more times 
		return value!=null && value.matches("^[a-zA-Z]+$");	
		
	}
	
	// 3. Method to validate if a string starts with alphabets and contains both alphabets and numbers
	...
	// 6. Method to validate if the password is composed of least 1 capital letter, 1 number and 1 symbol
	...
	// 7. Method to validate if the retyped password matches with pre-entered password
	...
	// 9. Method to validate if a part's file extension match with image file extensions (jpeg, jpg, png , gif)
